...
// document.querySelector('#calcTime').innerText = `time to calculate stats for ${options.PF_BATCH_SIZE} pokemon (${(options.PF_BATCH_SIZE*options.IV_BATCH_SIZE).toLocaleString()} calculations): ${(calcTime/1000).toFixed(3)} s`
// console.log(cps)
// });
// }
