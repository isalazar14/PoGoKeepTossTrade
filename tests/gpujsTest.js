...
import { displayHardwareSupport, runCalcPerfTest, getCalcTimeRowCell, getPokeForms, } from "./gpujsTestHelpers";
import { createIvMatrix, getCorrectCpms } from "./pokeCalcHelpers";
import { getCalcCPMsAtCpLimit_CPU, getTrueCpmsFromCalcCpms_CPU, } from "./pokeCalcsCPU";
import { calcCP, calcCpmsAtCpLimit, createKernel, getTrueCpmIdxsFromCalcCpms, getTrueCpmsFromCalcCpms, getTrueCpmsFromCpmIdxs, } from "./pokeCalcsGPU";
...
if (calcParams.IV_BATCH_SIZE > 0)
    ivs = ivs.slice(0, calcParams.IV_BATCH_SIZE);
// console.log(ivs)
// prettier-ignore
