...
const getOutput = gpu.createKernel(function(){
...
// const array3DToTexture = gpu.createKernel(
//   function (array) {
...
//   ],
// ];
// array3DToTexture.setOutput([4, 2, 2]);
// const result = array3DToTexture(array2D);
// console.log(result);
// console.log(result.map(l2array=> l2array.map((innerArray) => [...innerArray])));

// //#region TESTING REUSING A KERNEL FOR DERIVED ITERATIONS
...
// // };
// //#endregion TESTING REUSING A KERNEL FOR DERIVED ITERATIONS
